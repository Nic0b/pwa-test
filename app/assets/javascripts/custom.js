...
//        }
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
        ...
        if (isMobile.iOS()) {
            function notch(){
                var deviceHasNotch = "true";
                $('body').addClass('has-notch');
                if(deviceHasNotch === "true"){
                    $('body').addClass('has-notch');
                    $('body').append('<div class="notch-hider"></div>');
                    $('body, #page, .menu-box-modal, .menu-box-left, .menu-box-right, .menu-box-top').css('margin-top','44px');
                }
            }
        ...
        if(geoLocation.lengt){activate_geolocation();}
